...
int main() {
    ...
    double** train_images1 = loadMNISTImages<double>("../data/train-images.idx3-ubyte", 60000);
    double** train_labels1 = loadMNISTLabels<double>("../data/train-labels.idx1-ubyte", 60000);
    double** test_images1 = loadMNISTImages<double>("../data/t10k-images.idx3-ubyte", 10000);
    double** test_labels1 = loadMNISTLabels<double>("../data/t10k-labels.idx1-ubyte", 10000);

    // NeuralNetworkCPU* netCPU = createNetworkCPU();
    // trainCPU(netCPU, train_images1, train_labels1, 60000);
